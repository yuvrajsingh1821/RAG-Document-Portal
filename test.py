...
def test_document_ingestion_and_rag():
    try:
        test_files = [
            "/Users/yuvrajsingh/Developer/Document-Portal/data/multi_doc_chat/NIPS-2017-attention-is-all-you-need-Paper.pdf"
        ]
        uploaded_files = []
        ...
        rag = ConversationalRAG(retriever=retriever, session_id=session_id)
        question = "What are the key finding in this research paper?"
        response = rag.invoke(question)
        print(f"\nQuestion: {question} \nAnswer: {response}")
