...
class FaissManager:
    ...
    def _exists(self) -> bool:
        return (self.index_dir / "index.faiss").exists() (self.index_dir / "index.pkl").exists()
    ...
    def load_or_create(self, texts: Optional[List[str]]=None, metadatas: Optional[List[dict]]=None):
        ...
        self.vs = FAISS.from_texts(text=texts, embedding=self.emb, metadatas=metadatas or [])
        self.vs.save_local(str(self.index_dir))
        return self.vs
...
class ChatIngester:
    ...
    def _split(self, docs: List[Document], chunk_size=1000, chunk_overlap=200) -> List[Document]:
        ...
        self.log.info("Document split", chunks = len(chunks), chunk_size=chunk_size, overlap=chunk_overlap)
        return chunks

    def build_retriever(self, uploaded_files: Iterable, *, chunk_size:int = 1000, chunk_overlap: int = 200, k: int = 5):
        try:
