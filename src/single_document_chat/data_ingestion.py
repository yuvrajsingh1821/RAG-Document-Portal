...
class SingleDocIngestor:
    def __init__(self, data_dir: str = "data/single_document_chat", faiss_dir: str = "faiss_index"):
        try:
            ...
            self.log.info("SingleDocIngestor initialized", temp_path=str(self.data_dir), faiss_path=str(self.data_dir))
        except Exception as e:
            self.log.error(f"Error initializing SingleDocIngester: {e}")
            raise DocumentPortalException("Error initializing SingleDocIngester", sys)
    ...
    def _create_retriver(self, documents):
        try:
            ...
            self.log.info("Document splits into chunks", count = len(chunks))
