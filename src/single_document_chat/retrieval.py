...
class ConversationalRAG:
    def __init__(self, session_id:str, retriever) -> None:
        try:
            ...
            self.log.info("Initializing ConversationalRAG", session_id=session_id)
    ...
    def _get_session_history(self, session_id: str):
        try:
            ...
            raise DocumentPortalException("Failed to access session history", sys)
    ...
    def load_retriever_from_faiss(self, index_path: str):
        try:
            ...
            self.log.error("Failed to load the retriever from FAISS", error = str(e), session_id = self.session_id)
